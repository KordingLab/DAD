function Results = apply_2Dmodelselect(Results) 
...
if strcmp(monkey,'jango')
    [Yte1,Tte1,Xte1] = compile_jango_neuraldata(whichtarg,numSfinal,numDfinal,'~/Documents/repos/DAD/data/Jango/binnedData_0801.mat');
    [Yte2,Tte2,Xte2] = compile_jango_neuraldata(whichtarg,numSfinal,numDfinal,'~/Documents/repos/DAD/data/Jango/binnedData_0807.mat');
    [Yte3,Tte3,Xte3] = compile_jango_neuraldata(whichtarg,numSfinal,numDfinal,'~/Documents/repos/DAD/data/Jango/binnedData_0819.mat');
    [Yte4,Tte4,Xte4] = compile_jango_neuraldata(whichtarg,numSfinal,numDfinal,'~/Documents/repos/DAD/data/Jango/binnedData_0901.mat');
    ...
    [Vout4, ~] = runDAD2d(Yte4,Xtr,drmethodfinal,sfacfinal);
